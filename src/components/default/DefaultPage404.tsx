...
const Default404 = () => {
    ...
    return (
        <div data-testid="header404" className='card d-flex w-50 justify-content-center align-items-center mx-auto my-5 p-5' style={{ minHeight: "60.9vh" }}>
            <h1 className='alert alert-danger' aria-label="You Lost" data-toggle="tooltip" data-placement="top" title="You Lost">You Lost 😂😂😂😂</h1>
